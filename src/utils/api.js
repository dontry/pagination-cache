...
const BASE_URL  = `https://dh-atratadev.atrmywizard360.com/atr-gateway/ticket-management/api/v1/tickets`
...
const options = {
  baseURL: BASE_URL,
  headers: { "apiToken": "XMLHttpRequest", "Content-Type": "application/json", "Accept": "application/json"},
  timeout: 10000
};
